...
namespace Phosphor
{
    ...
    public partial class IconsSelection
    {
    ...
    public partial class IconsSelection
    {
        public static IconsSelection FromJson(string json) => JsonSerializer.Deserialize<IconsSelection>(json, Phosphor.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this IconsSelection self) => JsonSerializer.Serialize(self, Phosphor.Converter.Settings);
    }
